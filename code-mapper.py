...
if __name__ == "__main__":
    if len(sys.argv) <=1:
        print 'please enter Interface prefix,eg:python code-mapper AlarmRule'
        sys.exit(-1)
    filenames=[]
    filenames=sys.argv[1:]
    for filename in filenames:
        f_w_name = filename+"Mapper.java"
        f_w = open(f_w_name,"w")
        f_w.write("package com.netease.sentry.biz.persistence;\n")
        ...
        f_w.write("public interface "+filename+"Mapper {\n");
